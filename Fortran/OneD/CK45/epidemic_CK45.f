...
c     n are the number of modes (a power of 2)
      ...
      double precision lambda,epsilon,delta
* SERVICE VARIABLES
...
c     stores the data from 5th order scheme
      open(51,file='epidemic_CK45.dat',status='unknown')
c     stores the data from 4th order scheme
      open(52,file='epidstar_CK45.dat',status='unknown')
